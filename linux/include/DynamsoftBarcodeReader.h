...
* @{
* Karans.Dev Barcode Reader - C/C++ APIs Description.
*/
...
extern "C" {
	...
	*/
	 ...
	 * @{
	 *   APIs for initiating Karans.Dev Barcode Reader SDK.
	 */

	 /**
	  * Creates an instance of Karans.Dev Barcode Reader.
	  *
	  * @return Returns an instance of Karans.Dev Barcode Reader. If failed, returns NULL.
	  *
	  * @par Remarks:
	...
	/**
	 * Destroys an instance of Karans.Dev Barcode Reader.
	 *
